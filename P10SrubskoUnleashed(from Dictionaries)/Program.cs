...
namespace P10SrubskoUnleashed_from_Dictionaries_
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                bool hasTicketCount = int.TryParse(venueAndTicketsTokens[venueAndTicketsTokens.Length - 1], out int ticketCount);

                bool hasTicketPrice = int.TryParse(venueAndTicketsTokens[venueAndTicketsTokens.Length - 2], out int ticketPrice);
